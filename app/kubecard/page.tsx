    ...
    <>
      <main className="wrap">
        ...
        <section className="hero glass">
          ...
          <p>
            Research + writing + artifacts. This is the “library shelf” page: tidy structure,
            clear links, and commit-backed updates.
          </p>
          ...
          <div className="row">
            <a
              ...
              href="https://github.com/missjessicahe/KubeCard"
              target="_blank"
              rel="noreferrer"
            >
              GitHub ↗
        ...
        <section className="grid">
          <div className="card glass">
            ...
            <ul>
              ...
              <li>Papers / citations</li>
              <li>Artifacts + links</li>
            </ul>
          </div>
          ...
          <div className="card glass">
            <h3>Reading mode</h3>
            <p>
              Later we can add a “paper layout” option: wider margins, serif toggle, and footnote styling.
            </p>
          </div>
          ...
          <div className="card glass">
            <h3>Update ritual</h3>
            <p>
              Edit → commit → push → rebuild. No admin panel needed, so it stays alive.
            </p>
          </div>
        </section>
